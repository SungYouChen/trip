...
@section('content')
    ...
    <div class="mb-8">
        ...
        <!-- 協作討論區 (Collaborative Comment Board) -->
            ...
            <div class="muji-card p-4 sm:p-6 border border-muji-edge shadow-muji shadow-muji-oak/5 rounded-[32px] w-full">
                ...
                <div class="grid lg:grid-cols-4 gap-8">
                    ...
                    <div class="lg:col-span-3">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="bg-muji-paper p-4 rounded-3xl rounded-tl-none border border-muji-edge/60 text-sm text-muji-ink leading-relaxed shadow-muji-sm hover:shadow-muji transition-all duration-300 whitespace-pre-wrap">@php 
                                            ...
                                            $content = preg_replace(
                                                '/(https?:\/\/[^\s]+)/', 
                                                '<a href="$1" target="_blank" class="text-muji-oak hover:underline break-all underline decoration-dotted decoration-muji-wheat">$1</a>', 
                                                $content
                                            );
                                            echo $content;
                                        @endphp</div>
                        ...
                        <!-- 留言表單 (Add Comment Form) -->
                        <form action="{{ $isShared ? route('day.comments.store_shared', ['dayId' => $day['id']]) : route('day.comments.store', ['dayId' => $day['id']]) }}" 
                              method="POST"
                              class="relative mt-8 pt-8 border-t border-muji-edge/20">
                            @csrf
                            @if($isShared)
                                <div class="mb-4">
